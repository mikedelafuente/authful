      ...
      <div class="collapse navbar-collapse" id="bdNavbar">
        <ul class="navbar-nav flex-row flex-wrap bd-navbar-nav pt-2 py-md-0">
          ...
          <li class="nav-item col-6 col-md-auto">
            <router-link class="nav-link p-2" active-class="active" to="/"
              >Home</router-link
            >
          </li>
          <li class="nav-item col-6 col-md-auto">
            <router-link class="nav-link p-2" active-class="active" to="/about"
              >About</router-link
            >
          </li>
        </ul>
        ...
        <ul class="navbar-nav flex-row flex-wrap ms-md-auto">
          <li class="nav-item col-6 col-md-auto">
            <a
              class="nav-link p-2"
              href="https://github.com/mikedelafuente/authful"
              target="_blank"
              rel="noopener"
            >
              <svg
          ...
          <li class="nav-item col-6 col-md-auto">
            <a
              class="nav-link p-2"
              href="https://twitter.com/highfiveboom"
              target="_blank"
              rel="noopener"
            >
              <svg
